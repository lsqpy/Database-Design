...
CREATE TABLE `article` (
  ...
  `article_litpic` varchar(50) DEFAULT '' COMMENT '缩略图',
  ...
  `article_hits` int(11) NOT NULL DEFAULT '0' COMMENT '点击率',
  `article_status` tinyint(1) NOT NULL DEFAULT '0' COMMENT '点击数',
